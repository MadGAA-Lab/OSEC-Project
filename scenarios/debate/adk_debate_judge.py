...
class DebateJudgeOpenAI(GreenAgent):
    ...
    async def orchestrate_debate(
        ...
        response = await turn("con_debater",
...
"""
        ...
        completion = self._client.beta.chat.completions.parse(
            ...
            messages=[
                ...
                ChatCompletionUserMessageParam(content=judge_prompt, role="user"),
            ],
...
def main():
    ...
    agent_card = debate_judge_agent_card("DebateJudgeOpenAI", args.card_url or f"http://{args.host}:{args.port}/")
